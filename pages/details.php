    ...
    <div style="position: relative; background: url('<?= $backdrop ?>') center/cover; padding: 4rem; display: flex; gap: 3rem; align-items: center; justify-content: center; min-height: 60vh; flex-wrap: wrap;">
        ...
        <div style="position: relative; z-index: 10; max-width: 700px;">
            ...
            <div style="display: flex; gap: 1rem; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap;">
                ...
                <button class="btn-primary" style="padding: 0.7rem 1.5rem;"><i class="fas fa-play"></i> Trailer</button>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding-top: 2rem; padding-bottom: 4rem;">
        ...
        <div style="background: rgba(255,255,255,0.02); padding: 2rem; border-radius: 12px; border: 1px solid #262626; margin-bottom: 3rem;">
            ...
            <form action="#" method="POST" style="display: flex; flex-direction: column; gap: 1.2rem;">
                ...
                <textarea placeholder="Apa yang kamu pikirkan tentang film ini?" rows="4" style="width: 100%; padding: 1.2rem; border-radius: 8px; background: #080808; border: 1px solid #333; color: white; resize: vertical; font-family: inherit; font-size: 1rem; outline: none;"></textarea>
                <button type="button" class="btn-primary" style="align-self: flex-start; padding: 0.8rem 2rem; border-radius: 30px;">Kirim Review</button>
            </form>
        </div>
    </div>
</main>
