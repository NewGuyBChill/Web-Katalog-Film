...
<main class="split-card-wrapper">
    <div class="split-card">
        ...
        <div class="split-right">
            ...
            <h2 style="font-size: 2rem; font-weight: 800; color: var(--text-main); margin-bottom: 0.8rem; line-height: 1.2;"><?= translateText('create_account') ?></h2>
            <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2.5rem; line-height: 1.5;"><?= translateText('signup_desc') ?></p>
            ...
            <form method="POST" style="display: flex; flex-direction: column; gap: 1.2rem;">
                <div>
                    <label style="display: block; font-size: 0.85rem; font-weight: 700; color: var(--text-main); margin-bottom: 0.6rem;">Full Name</label>
                    <input type="text" name="name" class="auth-input-modern" required placeholder="John Doe">
                </div>
                <div>
                    <label style="display: block; font-size: 0.85rem; font-weight: 700; color: var(--text-main); margin-bottom: 0.6rem;">Your email</label>
                    <input type="email" name="email" class="auth-input-modern" required placeholder="name@domain.com">
                </div>
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="password" name="password" id="password" class="auth-input-modern" required minlength="6" placeholder="••••••••••" style="padding-right: 45px;">
                ...
                <button type="submit" class="auth-btn-modern">Create Account</button>
            </form>
            ...
            <div style="text-align: center; font-size: 0.9rem; color: var(--text-muted); font-weight: 500;">
                Already have an account? <a href="index.php?page=login" style="color: var(--accent); font-weight: 700; text-decoration: none; transition: 0.3s;">Log in</a>
            </div>
        </div>
    </div>
</main>